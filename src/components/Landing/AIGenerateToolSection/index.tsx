...
export const AIGenerateToolSection = () => {
    return (
        <section id="ai-tool" className="relative overflow-hidden bg-[#010205]">
            <div className="flex justify-center w-full mb-8">
                <GoldText absolute={false} className="text-4xl md:!text-5xl !tracking-normal">
                    AI GENERATE TOOL
                </GoldText>
            </div>
            <div className="border-2 border-accent/30 container mx-auto rounded-3xl p-6 relative overflow-hidden group">
