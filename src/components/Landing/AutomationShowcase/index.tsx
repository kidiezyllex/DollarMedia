    ...
    <>
      ...
      <section className="relative px-4 bg-black overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="border-2 border-accent/30 mb-8 rounded-3xl p-6 md:p-10 bg-black/40 backdrop-blur-md relative overflow-hidden group">
          ...
          <div className="border-2 border-accent/30 rounded-3xl p-4 bg-black/40 backdrop-blur-md relative mb-8">
          ...
          <div className="border-2 border-accent/30 rounded-3xl p-4 bg-black/40 backdrop-blur-md relative overflow-hidden">
