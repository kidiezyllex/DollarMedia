...
const badgeVariants = cva(
  "flex items-center justify-center border px-2 py-1 h-fit rounded-[4px] font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 cursor-pointer text-sm h-6 leading-[1px] w-fit text-nowrap px-1.5 py-0 text-xs gap-1",
  {
    variants: {
      variant: {
        ...
        blue: "bg-blue-500/10 text-secondary border-blue-500/20",
        indigo:
